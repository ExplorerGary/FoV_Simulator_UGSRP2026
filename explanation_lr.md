...
| 2026-08-03 | pending | 新增 CPU-only 双固定机位 6DoF 轨迹可视化：以对齐坐标系的中点 DanceNet3D GT PLY 为背景，仅对已有 prediction 的 2 个 CircleTurns trace 分别输出蓝色 GT-only 弧线和蓝色 GT + 黄色 LR predicted DoF 合成弧线；Slurm array 不重新训练或推理，并以 20k 点云/180 轨迹点控制在约 10 秒量级。 |
